...
class Field {
	...
	public function __construct($is_primary_key = false, $default = null, $description = '', $max_length = 1, $auto_increment = false) {
...
class CharField extends Field {
	...
	public function __construct($max_length, $is_primary_key = false, $default = '', $encoding = 'utf8', $collate = 'utf8_general_ci', $description = '') {
...
class IntField extends Field {
	...
	public function __construct($is_primary_key = false, $auto_increment = false, $default = 0, $description = '', $unsigned = true) {
...
class BigIntField extends Field {
	...
	public function __construct($max_length = 20, $is_primary_key = false, $auto_increment = false, $default = 0, $description = '', $unsigned = true) {
